...
namespace CSMS.Migrations
{
    ...
    [Migration("20240119172807_Task_TaskStatusId")]
    partial class TaskTaskStatusId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CSMS.Domain.Models.ContractModel", b =>
                {
            ...
            modelBuilder.Entity("CSMS.Domain.Models.CustomerModel", b =>
                {
                    b.Property<Guid>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CSMS.Domain.Models.Master.TaskStatusModel", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("TaskStatusId"));
            ...
            modelBuilder.Entity("CSMS.Domain.Models.ContractModel", b =>
                {
                    b.OwnsOne("CSMS.Domain.Models.ValueObject.AmountExcludingTax", "Money", b1 =>
                        {
                    ...
                    b.OwnsOne("CSMS.Domain.Models.ValueObject.TaxRate", "TaxRate", b1 =>
                        {
                            b1.Property<Guid>("ContractModelContractId")
                                .HasColumnType("uuid");
